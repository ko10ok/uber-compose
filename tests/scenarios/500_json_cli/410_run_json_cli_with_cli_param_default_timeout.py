...
class Scenario(vedro.Scenario):
    ...
    def then_timeout_should_be_passed_correctly(self):
        ...
        assert timeout_arg.attempts == 10
        assert timeout_arg.delay_s == 1
    ...
    def then_assertion_error_should_contain_timeout_parameters(self):
        self.error_message = str(self.exc_info.value)
        assert 'attempts=10' in self.error_message
        assert 'delay_s=1' in self.error_message
